classdef DagNNViz < handle
    ...
    methods
        ...
        function plot_noisy_params(obj, params_path, noisy_params_path, snr, dt_sec)
            ...
            for i = 1 : length(fields)
                ...
                set(gca, ...
                    'YTick', ...
                    unique([...
                        round(min(min(noisless), min(noisy)), obj.round_digits), ...
                        round(max(max(noisless), max(noisy)), obj.round_digits) ...
                    ]) ...
                );
                %   - grid
                grid('on');
                ...
                % save
                obj.saveas([lower(param.title), '_filter_noisy_noiseless']);
            end            
        end
